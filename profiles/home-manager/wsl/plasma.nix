...
{lib, ...}: {
  programs.plasma = {
    enable = true;
    shortcuts = lib.mkForce {
      "ActivityManager"."switch-to-activity-2fceeaf5-e7eb-41ea-9108-13788b24131a" = [];
      "KDE Keyboard Layout Switcher"."Switch keyboard layout to English (US)" = [];
      "KDE Keyboard Layout Switcher"."Switch to Next Keyboard Layout" = "F23+F24+K";
      ...
      "bismuth"."decrease_window_width" = "F23+J";
      "bismuth"."focus_bottom_window" = [];
      "bismuth"."focus_left_window" = [];
      "bismuth"."focus_next_window" = "F23+K";
      "bismuth"."focus_prev_window" = "F23+I";
      ...
      "bismuth"."increase_window_width" = "F23+L";
      "bismuth"."move_window_to_bottom_pos" = [];
      "bismuth"."move_window_to_left_pos" = [];
      "bismuth"."move_window_to_next_pos" = "F23+Shift+K";
      "bismuth"."move_window_to_prev_pos" = "F23+Shift+I";
      "bismuth"."move_window_to_right_pos" = [];
      "bismuth"."move_window_to_upper_pos" = [];
      "bismuth"."next_layout" = "F23+\\,F23+\\,Switch to the Next Layout";
      "bismuth"."prev_layout" = "F23+|";
      "bismuth"."push_window_to_master" = "F23+Shift+M";
      "bismuth"."rotate" = [];
      "bismuth"."rotate_part" = [];
      "bismuth"."rotate_reverse" = [];
      "bismuth"."toggle_float_layout" = "F23+F";
      "bismuth"."toggle_monocle_layout" = "F23+M";
      ...
      "kwin"."Kill Window" = "F23+Ctrl+Esc";
      "kwin"."Move Tablet to Next Output" = [];
      "kwin"."MoveMouseToCenter" = "F23+F6";
      "kwin"."MoveMouseToFocus" = "F23+F5";
      "kwin"."MoveZoomDown" = [];
      "kwin"."MoveZoomLeft" = [];
      "kwin"."MoveZoomRight" = [];
      "kwin"."MoveZoomUp" = [];
      ...
      "kwin"."PoloniumFocusLeft" = "F23+H";
      "kwin"."PoloniumFocusRight" = [];
      "kwin"."PoloniumInsertAbove" = [];
      "kwin"."PoloniumInsertBelow" = [];
      "kwin"."PoloniumInsertLeft" = "F23+Shift+H";
      "kwin"."PoloniumInsertRight" = [];
      "kwin"."PoloniumRetileWindow" = "F23+Shift+Space";
      "kwin"."PoloniumSwapAbove" = "F23+Ctrl+K";
      "kwin"."PoloniumSwapBelow" = "F23+Ctrl+J";
      "kwin"."PoloniumSwapLeft" = "F23+Ctrl+H";
      "kwin"."PoloniumSwapRight" = "F23+Ctrl+L";
      "kwin"."Setup Window Shortcut" = [];
      "kwin"."Show Desktop" = "F23+D";
      "kwin"."ShowDesktopGrid" = "F23+F8";
      "kwin"."Suspend Compositing" = "F24+Shift+F12";
      ...
      "kwin"."Switch Window Down" = "F23+F24+Down";
      "kwin"."Switch Window Left" = "F23+F24+Left";
      "kwin"."Switch Window Right" = "F23+F24+Right";
      "kwin"."Switch Window Up" = "F23+F24+Up";
      "kwin"."Switch to Desktop 1" = "F23+1";
      "kwin"."Switch to Desktop 10" = "F23+0";
      ...
      "kwin"."Switch to Desktop 2" = "F23+2";
      "kwin"."Switch to Desktop 20" = [];
      "kwin"."Switch to Desktop 3" = "F23+3";
      "kwin"."Switch to Desktop 4" = "F23+4";
      "kwin"."Switch to Desktop 5" = "F23+5";
      "kwin"."Switch to Desktop 6" = "F23+6";
      "kwin"."Switch to Desktop 7" = "F23+7";
      "kwin"."Switch to Desktop 8" = "F23+8";
      "kwin"."Switch to Desktop 9" = "F23+9";
      ...
      "kwin"."Walk Through Windows" = "F24+Tab";
      "kwin"."Walk Through Windows (Reverse)" = "F24+Shift+Backtab";
      "kwin"."Walk Through Windows Alternative" = [];
      "kwin"."Walk Through Windows Alternative (Reverse)" = [];
      "kwin"."Walk Through Windows of Current Application" = "F24+`";
      "kwin"."Walk Through Windows of Current Application (Reverse)" = "F24+~";
      "kwin"."Walk Through Windows of Current Application Alternative" = [];
      "kwin"."Walk Through Windows of Current Application Alternative (Reverse)" = [];
      "kwin"."Window Above Other Windows" = [];
      "kwin"."Window Below Other Windows" = [];
      "kwin"."Window Close" = "F23+Q";
      "kwin"."Window Fullscreen" = "F23+Shift+F";
      "kwin"."Window Grow Horizontal" = [];
      "kwin"."Window Grow Vertical" = [];
      "kwin"."Window Lower" = [];
      "kwin"."Window Maximize" = "F23+PgUp";
      "kwin"."Window Maximize Horizontal" = [];
      "kwin"."Window Maximize Vertical" = [];
      "kwin"."Window Minimize" = "F23+X";
      "kwin"."Window Move" = [];
      "kwin"."Window Move Center" = [];
      "kwin"."Window No Border" = [];
      "kwin"."Window On All Desktops" = [];
      "kwin"."Window One Desktop Down" = "F23+Ctrl+Shift+Down";
      "kwin"."Window One Desktop Up" = "F23+Ctrl+Shift+Up";
      "kwin"."Window One Desktop to the Left" = "F23+Ctrl+Shift+Left";
      "kwin"."Window One Desktop to the Right" = "F23+Ctrl+Shift+Right";
      "kwin"."Window One Screen Down" = [];
      "kwin"."Window One Screen Up" = [];
      "kwin"."Window One Screen to the Left" = [];
      "kwin"."Window One Screen to the Right" = [];
      "kwin"."Window Operations Menu" = "F24+F3";
      "kwin"."Window Pack Down" = [];
      "kwin"."Window Pack Left" = [];
      "kwin"."Window Pack Right" = [];
      "kwin"."Window Pack Up" = [];
      "kwin"."Window Quick Tile Bottom" = "F23+Down";
      "kwin"."Window Quick Tile Bottom Left" = [];
      "kwin"."Window Quick Tile Bottom Right" = [];
      "kwin"."Window Quick Tile Left" = "F23+Left";
      "kwin"."Window Quick Tile Right" = "F23+Right";
      "kwin"."Window Quick Tile Top" = "F23+Up";
      ...
      "kwin"."Window to Desktop 1" = "F23+!";
      "kwin"."Window to Desktop 10" = "F23+)";
      ...
      "kwin"."Window to Desktop 2" = "F23+@";
      "kwin"."Window to Desktop 20" = [];
      "kwin"."Window to Desktop 3" = "F23+#";
      "kwin"."Window to Desktop 4" = "F23+$";
      "kwin"."Window to Desktop 5" = "F23+%";
      "kwin"."Window to Desktop 6" = "F23+^";
      "kwin"."Window to Desktop 7" = "F23+&";
      "kwin"."Window to Desktop 8" = "F23+*";
      "kwin"."Window to Desktop 9" = "F23+(";
      "kwin"."Window to Next Desktop" = "F23+Shift+L";
      "kwin"."Window to Next Screen" = ["F23+>" "F23+Shift+Right"];
      "kwin"."Window to Previous Desktop" = "F23+Shift+J";
      "kwin"."Window to Previous Screen" = ["F23+Shift+Left" "F23+<"];
      ...
      "kwin"."karousel-column-move-end" = "F23+Ctrl+Shift+End";
      "kwin"."karousel-column-move-left" = "F23+Ctrl+Shift+A";
      "kwin"."karousel-column-move-right" = "F23+Ctrl+Shift+D";
      "kwin"."karousel-column-move-start" = "F23+Ctrl+Shift+Home";
      "kwin"."karousel-column-move-to-column-1" = "F23+Ctrl+Shift+1";
      "kwin"."karousel-column-move-to-column-2" = "F23+Ctrl+Shift+2";
      "kwin"."karousel-column-move-to-column-3" = "F23+Ctrl+Shift+3";
      "kwin"."karousel-column-move-to-column-4" = "F23+Ctrl+Shift+4";
      "kwin"."karousel-column-move-to-column-5" = "F23+Ctrl+Shift+5";
      "kwin"."karousel-column-move-to-column-6" = "F23+Ctrl+Shift+6";
      "kwin"."karousel-column-move-to-column-7" = "F23+Ctrl+Shift+7";
      "kwin"."karousel-column-move-to-column-8" = "F23+Ctrl+Shift+8";
      "kwin"."karousel-column-move-to-column-9" = "F23+Ctrl+Shift+9";
      "kwin"."karousel-column-move-to-desktop-1" = "F23+Ctrl+Shift+F1";
      "kwin"."karousel-column-move-to-desktop-10" = "F23+Ctrl+Shift+F10";
      "kwin"."karousel-column-move-to-desktop-11" = "F23+Ctrl+Shift+F11";
      "kwin"."karousel-column-move-to-desktop-12" = "F23+Ctrl+Shift+F12";
      "kwin"."karousel-column-move-to-desktop-2" = "F23+Ctrl+Shift+F2";
      "kwin"."karousel-column-move-to-desktop-3" = "F23+Ctrl+Shift+F3";
      "kwin"."karousel-column-move-to-desktop-4" = "F23+Ctrl+Shift+F4";
      "kwin"."karousel-column-move-to-desktop-5" = "F23+Ctrl+Shift+F5";
      "kwin"."karousel-column-move-to-desktop-6" = "F23+Ctrl+Shift+F6";
      "kwin"."karousel-column-move-to-desktop-7" = "F23+Ctrl+Shift+F7";
      "kwin"."karousel-column-move-to-desktop-8" = "F23+Ctrl+Shift+F8";
      "kwin"."karousel-column-move-to-desktop-9" = "F23+Ctrl+Shift+F9";
      ...
      "kwin"."karousel-focus-down" = "F23+S";
      "kwin"."karousel-focus-end" = "F23+End";
      "kwin"."karousel-focus-left" = [];
      "kwin"."karousel-focus-right" = [];
      "kwin"."karousel-focus-start" = "F23+Home";
      "kwin"."karousel-focus-up" = [];
      "kwin"."karousel-grid-scroll-end" = "F23+F24+End";
      "kwin"."karousel-grid-scroll-focused" = "F23+F24+Return";
      "kwin"."karousel-grid-scroll-left" = "F23+F24+PgUp";
      "kwin"."karousel-grid-scroll-left-column" = "F23+F24+A";
      "kwin"."karousel-grid-scroll-right" = "F23+F24+PgDown";
      "kwin"."karousel-grid-scroll-right-column" = "F23+F24+D";
      "kwin"."karousel-grid-scroll-start" = "F23+F24+Home";
      "kwin"."karousel-tail-move-to-desktop-1" = "F23+Ctrl+F24+Shift+F1";
      "kwin"."karousel-tail-move-to-desktop-10" = "F23+Ctrl+F24+Shift+F10";
      "kwin"."karousel-tail-move-to-desktop-11" = "F23+Ctrl+F24+Shift+F11";
      "kwin"."karousel-tail-move-to-desktop-12" = "F23+Ctrl+F24+Shift+F12";
      "kwin"."karousel-tail-move-to-desktop-2" = "F23+Ctrl+F24+Shift+F2";
      "kwin"."karousel-tail-move-to-desktop-3" = "F23+Ctrl+F24+Shift+F3";
      "kwin"."karousel-tail-move-to-desktop-4" = "F23+Ctrl+F24+Shift+F4";
      "kwin"."karousel-tail-move-to-desktop-5" = "F23+Ctrl+F24+Shift+F5";
      "kwin"."karousel-tail-move-to-desktop-6" = "F23+Ctrl+F24+Shift+F6";
      "kwin"."karousel-tail-move-to-desktop-7" = "F23+Ctrl+F24+Shift+F7";
      "kwin"."karousel-tail-move-to-desktop-8" = "F23+Ctrl+F24+Shift+F8";
      "kwin"."karousel-tail-move-to-desktop-9" = "F23+Ctrl+F24+Shift+F9";
      "kwin"."karousel-window-expand" = [];
      "kwin"."karousel-window-move-down" = "F23+Shift+S";
      "kwin"."karousel-window-move-end" = "F23+Shift+End";
      "kwin"."karousel-window-move-left" = [];
      "kwin"."karousel-window-move-right" = [];
      "kwin"."karousel-window-move-start" = "F23+Shift+Home";
      "kwin"."karousel-window-move-to-column-1" = "F23+Shift+1";
      "kwin"."karousel-window-move-to-column-2" = "F23+Shift+2";
      "kwin"."karousel-window-move-to-column-3" = "F23+Shift+3";
      "kwin"."karousel-window-move-to-column-4" = "F23+Shift+4";
      "kwin"."karousel-window-move-to-column-5" = "F23+Shift+5";
      "kwin"."karousel-window-move-to-column-6" = "F23+Shift+6";
      "kwin"."karousel-window-move-to-column-7" = "F23+Shift+7";
      "kwin"."karousel-window-move-to-column-8" = "F23+Shift+8";
      "kwin"."karousel-window-move-to-column-9" = "F23+Shift+9";
      "kwin"."karousel-window-move-up" = "F23+Shift+W";
      "kwin"."karousel-window-toggle-floating" = [];
      "kwin"."view_actual_size" = [];
      "kwin"."view_zoom_in" = ["F23++" "F23+="];
      "kwin"."view_zoom_out" = "F23+-";
      ...
      "org.kde.dolphin.desktop"."_launch" = "F23+E";
      "org.kde.konsole.desktop"."NewTab" = [];
      "org.kde.konsole.desktop"."NewWindow" = [];
      "org.kde.konsole.desktop"."_launch" = "Ctrl+F24+T";
      "org.kde.krunner.desktop"."RunClipboard" = "F24+Shift+F2";
      "org.kde.krunner.desktop"."_launch" = ["F24+Space" "F24+F2" "Search"];
      "org.kde.plasma.emojier.desktop"."_launch" = "F23+.";
      "org.kde.spectacle.desktop"."ActiveWindowScreenShot" = "F23+Print";
      ...
      "org.kde.spectacle.desktop"."RectangularRegionScreenShot" = "F23+Shift+Print";
      "org.kde.spectacle.desktop"."WindowUnderCursorScreenShot" = "F23+Ctrl+Print";
      ...
      "plasmashell"."clipboard_action" = "F23+Ctrl+X";
      "plasmashell"."cycle-panels" = "F23+F24+P";
      "plasmashell"."cycleNextAction" = [];
      "plasmashell"."cyclePrevAction" = [];
      "plasmashell"."edit_clipboard" = [];
      "plasmashell"."manage activities" = [];
      "plasmashell"."next activity" = "F23+Tab";
      "plasmashell"."previous activity" = "F23+Shift+Tab";
      "plasmashell"."repeat_action" = "F23+Ctrl+R";
      "plasmashell"."show dashboard" = "Ctrl+F12";
      "plasmashell"."show-barcode" = [];
      "plasmashell"."show-on-mouse-pos" = "F23+V";
    ...
    configFile = lib.mkForce {
      ...
      "khotkeysrc"."Data_2_1"."Comment" = "After pressing Ctrl+F24+I, the KSIRC window will be activated, if it exists. Simple.";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Key" = "Ctrl+F24+I";
      "khotkeysrc"."Data_2_1Triggers0"."Type" = "SHORTCUT";
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{bfea8022-efd1-4281-ac96-f7a115eb1326}";
      "khotkeysrc"."Data_2_2"."Comment" = "After pressing F24+Ctrl+H the input of 'Hello' will be simulated, as if you typed it.  This is especially useful if you have call to frequently type a word (for instance, 'unsigned').  Every keypress in the input is separated by a colon ':'. Note that the keypresses literally mean keypresses, so you have to write what you would press on the keyboard. In the table below, the left column shows the input and the right column shows what to type.\n\n\"enter\" (i.e. new line)                Enter or Return\na (i.e. small a)                          A\nA (i.e. capital a)                       Shift+A\n: (colon)                                  Shift+;\n' '  (space)                              Space";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Key" = "Ctrl+F24+H";
      "khotkeysrc"."Data_2_2Triggers0"."Type" = "SHORTCUT";
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{04c46ebe-3de0-438b-ab18-4ff6d5250b9a}";
      "khotkeysrc"."Data_2_3"."Comment" = "This action runs Konsole, after pressing Ctrl+F24+T.";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Key" = "Ctrl+F24+T";
      ...
      "khotkeysrc"."Data_2_5"."Comment" = "By pressing F24+Ctrl+W a D-Bus call will be performed that will show the minicli. You can use any kind of D-Bus call, just like using the command line 'qdbus' tool.";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Key" = "Ctrl+F24+W";
      "khotkeysrc"."Data_2_5Triggers0"."Type" = "SHORTCUT";
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{c055b476-0c9b-47c1-a45e-981a168a2489}";
      "khotkeysrc"."Data_2_6"."Comment" = "Read the comment on the \"Type 'Hello'\" action first.\n\nJust like the \"Type 'Hello'\" action, this one simulates keyboard input, specifically, after pressing Ctrl+F24+B, it sends B to XMMS (B in XMMS jumps to the next song). The 'Send to specific window' checkbox is checked and a window with its class containing 'XMMS_Player' is specified; this will make the input always be sent to this window. This way, you can control XMMS even if, for instance, it is on a different virtual desktop.\n\n(Run 'xprop' and click on the XMMS window and search for WM_CLASS to see 'XMMS_Player').";
      ...
      "khotkeysrc"."Data_2_7_1Actions0"."Input" = "F24+Left";
      ...
      "khotkeysrc"."Data_2_7_2Actions0"."Input" = "F24+Right";
      ...
      "khotkeysrc"."Data_2_7_3Actions0"."Input" = "F24+Up";
      ...
      "khotkeysrc"."Data_2_8"."Comment" = "After pressing Win+E (Tux+E) a WWW browser will be launched, and it will open http://www.kde.org . You may run all kind of commands you can run in minicli (F24+F2).";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Key" = "F23+E";
      ...
      "khotkeysrc"."Data_3_11Actions0"."Input" = "F24+Up";
      ...
      "khotkeysrc"."Data_3_12Actions0"."Input" = "F24+Up\n";
      ...
      "khotkeysrc"."Data_3_1Actions0"."Input" = "F24+Left";
      ...
      "khotkeysrc"."Data_3_4Actions0"."Input" = "F24+Right";
      ...
      "khotkeysrc"."Data_3_5Actions0"."Input" = "F24+Home\n";
