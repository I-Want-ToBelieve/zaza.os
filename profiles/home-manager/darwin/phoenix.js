...
function setAppPosition(app, relativeFrame, space) {
  ...
  if (space.screens().length > 1) {
    ...
    const left = typeof relativeFrame.left === 'string' ? screen.x + +relativeFrame.left : screen.x + relativeFrame.left * screen.width
    const top = typeof relativeFrame.top === 'string' ? screen.y + +relativeFrame.top : screen.y + relativeFrame.top * screen.height
