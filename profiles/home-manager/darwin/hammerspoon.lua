...
-- https://gist.gitmirror.com/truebit/d79b8018666d65e95970f208d8f5d149/raw
local spaces = require("hs.spaces") -- https://github.com/asmagill/hs._asm.spaces

-- Switch kitty
hs.hotkey.bind({'command'}, 't', function () -- change your own hotkey combo here, available keys could be found here:https://www.hammerspoon.org/docs/hs.hotkey.html#bind
    ...
    if kitty == nil and hs.application.launchOrFocusByBundleID(BUNDLE_ID) then
      ...
      appWatcher = hs.application.watcher.new(function(name, event, app)
        if event == hs.application.watcher.launched and app:bundleID() == BUNDLE_ID then
          getMainWindow(app):move(hs.geometry({x=0,y=0,w=0.7,h=0.6})) -- move kitty window on top, you could set the window percentage here
          app:hide()
