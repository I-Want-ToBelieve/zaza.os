...
class BurnMyWindowsPixelWheelEffect {
  constructor() {
    ...
    this.shader = effect.addFragmentShader(Effect.MapTexture, 'pixel-wheel.frag');
  ...
  slotWindowAdded(window) {
    ...
    if (!BurnMyWindowsPixelWheelEffect.shouldAnimateWindow(window)) {
      return;
    }
    if (!window.visible) {
      return;
...
new BurnMyWindowsPixelWheelEffect();
