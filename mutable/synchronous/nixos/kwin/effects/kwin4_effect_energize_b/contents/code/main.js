...
class BurnMyWindowsEnergizeBEffect {
  constructor() {
    ...
    this.shader = effect.addFragmentShader(Effect.MapTexture, 'energize-b.frag');
  ...
  slotWindowAdded(window) {
    ...
    if (!BurnMyWindowsEnergizeBEffect.shouldAnimateWindow(window)) {
      return;
    }
    if (!window.visible) {
      return;
...
new BurnMyWindowsEnergizeBEffect();
