...
class BurnMyWindowsHexagonEffect {
  constructor() {
    ...
    this.shader = effect.addFragmentShader(Effect.MapTexture, 'hexagon.frag');
  ...
  slotWindowAdded(window) {
    ...
    if (!BurnMyWindowsHexagonEffect.shouldAnimateWindow(window)) {
      return;
    }
    if (!window.visible) {
      return;
...
new BurnMyWindowsHexagonEffect();
