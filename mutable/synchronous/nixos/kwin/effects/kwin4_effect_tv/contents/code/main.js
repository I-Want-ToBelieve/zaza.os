...
class BurnMyWindowsTvEffect {
  constructor() {
    ...
    this.shader = effect.addFragmentShader(Effect.MapTexture, 'tv.frag');
  ...
  slotWindowAdded(window) {
    ...
    if (!BurnMyWindowsTvEffect.shouldAnimateWindow(window)) {
      return;
    }
    if (!window.visible) {
      return;
