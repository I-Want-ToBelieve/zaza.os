...
class BurnMyWindowsEnergizeAEffect {
  constructor() {
    ...
    this.shader = effect.addFragmentShader(Effect.MapTexture, 'energize-a.frag');
  ...
  slotWindowAdded(window) {
    ...
    if (!BurnMyWindowsEnergizeAEffect.shouldAnimateWindow(window)) {
      return;
    }
    if (!window.visible) {
      return;
...
new BurnMyWindowsEnergizeAEffect();
