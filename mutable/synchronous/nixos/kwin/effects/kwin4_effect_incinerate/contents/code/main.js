...
class BurnMyWindowsIncinerateEffect {
  constructor() {
    ...
    this.shader = effect.addFragmentShader(Effect.MapTexture, 'incinerate.frag');
  ...
  slotWindowAdded(window) {
    ...
    if (!BurnMyWindowsIncinerateEffect.shouldAnimateWindow(window)) {
      return;
    }
    if (!window.visible) {
      return;
...
new BurnMyWindowsIncinerateEffect();
