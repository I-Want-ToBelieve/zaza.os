...
function separators(a) {
  ...
  for (b = 0; b < c; b++) a.addWidget('org.kde.plasma.marginsseparator')
}
...
clock.writeConfig(
  'layout',
  '<html><body><center><span style="font-weight:500;">{DD:u} {d} {MM:u} {h}:{ii}</span></center></body></html>'
)
separators(paneltop)
/****************************/
...
if (width === 1920) {
  ...
  if (width === 1440) {
    ...
    if (width === 1280) {
      ...
      panelbottom.maximumLength = Number(width * 0.9)
    }
  }
}
panelbottom.minimumLength = 120
panelbottom.hiding = 'autohide'
