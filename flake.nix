      ...
      perSystem = {
        ...
        devenv.shells.default = {
          ...
          scripts."10r".exec = ''
            ...
            sh -c $'sleep 0.314;zellij -s r10 -s r10 action write-chars "zellij run -- nixos-rebuild switch --flake .#dell-makcoo --verbose --show-trace --impure --target-host root@192.168.0.102\n"' &
